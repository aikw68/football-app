...
- DUELSCORE
    ...
    - 情報はAPI（[football-data.org](https://www.football-data.org/)）を使い取得

## URL
※準備中..

※README下部にポートフォリオのスクリーンショットを掲載中
...
## 苦労した点
- Golangのエラーハンドリングの構成に時間を費やしている（現在進行形で見直し中）。
- Redisの操作方法（セッション生成、破棄など）について掲載されているサイトが少なかった。
